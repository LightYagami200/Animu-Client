    ...
    <v-container>
      <v-row>
        <v-col cols="12" sm="12">
          ...
          <p>
            By accessing this Website, accessible from https://animu.io,
          ...
          <p>
            ...
            materials on Animu.io's Website for personal, non-commercial
          ...
          <p>
            This will let Animu.io to terminate upon violations of any of
            ...
            electronic format. These Terms of Service has been created with
            the help of the
          ...
          <p>
            All the materials on Animu.io’s Website are provided "as is".
            Animu.io makes no warranties, may it be expressed or implied,
            therefore negates all other warranties. Furthermore, Animu.io
          ...
          <p>
            Animu.io or its suppliers will not be hold accountable for any
            damages that will arise with the use or inability to use the
            materials on Animu.io’s Website, even if Animu.io or an
          ...
          <p>
            The materials appearing on Animu.io’s Website may include
            technical, typographical, or photographic errors. Animu.io will
            not promise that any of the materials in this Website are
            accurate, complete, or current. Animu.io may change the
            materials contained on its Website at any time without notice.
            Animu.io does not make any commitment to update the materials.
          </p>

          <h2>6. Links</h2>

          <p>
            Animu.io has not reviewed all of the sites linked to its
            Website and is not responsible for the contents of any such
            linked site. The presence of any link does not imply
            endorsement by Animu.io of the site. The use of any linked
          ...
          <p>
            Animu.io may revise these Terms of Use for its Website at any
          ...
          <p>
            Any claim related to Animu.io's Website shall be governed by
            the laws of pk without regards to its conflict of law
            provisions.
          </p>
        </v-col>
      </v-row>
